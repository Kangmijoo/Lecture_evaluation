...
public class EvaluationDTO {
	...
	public String getSamesterDivide() {
		return samesterDivide;
	}
	public void setSamesterDivide(String samesterDivide) {
		this.samesterDivide = samesterDivide;
	}
	...
	public EvaluationDTO(int evaluationID, String userID, String lectureName, String professorName, int lectureYear,
			String samesterDivide, String lectureDivide, String evaluationTitle, String evaluationContent,
